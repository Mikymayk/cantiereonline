...
export default async function SoftwarePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const software = softwareDE.find((s) => s.id === id);
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <header className="border-b border-gray-100 p-4 sticky top-0 bg-white/95 backdrop-blur z-50">
         <div className="max-w-4xl mx-auto flex items-center">
             <Link href="/de" className="text-slate-500 hover:text-blue-600 flex items-center gap-2 font-bold text-sm">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="flex gap-4 mb-12">
            <a href={software.website} target="_blank" className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center py-4 rounded-xl font-bold shadow-lg transition-all flex items-center justify-center gap-2">
                Webseite besuchen <ExternalLink size={18}/>
            </a>
        ...
        <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4 text-slate-900">Über {software.name}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-green-50 p-6 rounded-2xl border border-green-100">
                <h3 className="font-bold text-green-800 mb-4 flex items-center gap-2">
                    <Check className="bg-green-200 rounded-full p-1" size={24}/> Vorteile
                </h3>
            ...
            <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
                <h3 className="font-bold text-red-800 mb-4 flex items-center gap-2">
                    <X className="bg-red-200 rounded-full p-1" size={24}/> Nachteile
                </h3>
                <ul className="space-y-3">
        ...
        {/* Features Table */}
        <section>
            <h2 className="text-2xl font-bold mb-6 text-slate-900">Funktionen im Detail</h2>
