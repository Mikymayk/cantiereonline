      ...
      <main className="max-w-7xl mx-auto px-2 md:px-4 py-8 flex-grow">
        ...
        {!showDeepCompare ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
            ...
            {/* UX MOBILE: OMBREGGIATURA "FADE" A DESTRA PER SUGGERIRE SCROLL */}
            <div className="absolute top-0 bottom-0 right-0 w-8 bg-gradient-to-l from-slate-200/50 to-transparent pointer-events-none z-10 md:hidden"></div>
              ...
              <table className="w-full text-left border-collapse min-w-[1000px] divide-x divide-gray-100">
                ...
                <thead>
                  <tr className="bg-slate-50 border-b border-gray-200 text-xs font-bold text-gray-600 uppercase tracking-wider divide-x divide-gray-200">
                    <th className="p-4 text-center w-12 bg-slate-100 sticky left-0 z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">CF</th>
            ...
            <div className="p-3 bg-blue-50 text-blue-800 text-xs text-center border-t border-blue-100 flex justify-center items-center gap-2 font-medium animate-pulse">
              <span className="md:hidden flex items-center gap-1">
                👉 Scorri verso destra per vedere tutto <ChevronRight size={14} />
              </span>
